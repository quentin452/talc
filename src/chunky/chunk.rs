...
impl From<Position> for VoxelIndex {
    fn from(value: Position) -> Self {
        let x: usize = value
            .x
            .try_into()
            .expect("[From<Position> for VoxelIndex] Expected x to be nonnegative.");
        let y: usize = value
            .y
            .try_into()
            .expect("[From<Position> for VoxelIndex] Expected y to be nonnegative.");
        let z: usize = value
            .z
            .try_into()
            .expect("[From<Position> for VoxelIndex] Expected z to be nonnegative.");
        Self::new(x, y, z)
    }
}
