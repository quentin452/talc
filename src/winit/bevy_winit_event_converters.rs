// https://github.com/bevyengine/bevy/blob/main/crates/bevy_winit/src/converters.rs

use crate::bevy::prelude::*;
use bevy_input::{keyboard::{KeyboardInput, NativeKeyCode}, ButtonState};
...
fn convert_element_state(element_state: winit::event::ElementState) -> ButtonState {
    match element_state {
...
fn convert_physical_native_key_code(
...
fn convert_physical_key_code(virtual_key_code: winit::keyboard::PhysicalKey) -> KeyCode {
...
fn convert_native_key(native_key: &NativeKey) -> bevy_input::keyboard::NativeKey {
    match native_key {
...
fn convert_logical_key(logical_key_code: &Key) -> bevy_input::keyboard::Key {
