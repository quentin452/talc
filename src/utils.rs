...
#[inline]
#[must_use] pub const fn index_to_ivec3(i: i32) -> IVec3 {
    let x = i % 32;
    let y = (i / 32) % 32;
    let z = i / (32 * 32);
    IVec3::new(x, y, z)
...
#[inline]
#[must_use] pub const fn index_to_ivec3_bounds(i: i32, bounds: i32) -> IVec3 {
    let x = i % bounds;
...
#[inline]
#[must_use] pub const fn index_to_ivec3_bounds_reverse(i: i32, bounds: i32) -> IVec3 {
    let z = i % bounds;
    let y = (i / bounds) % bounds;
...
#[inline]
#[must_use] pub const fn is_on_edge(pos: IVec3) -> bool {
    if pos.x == 0 || pos.x == 32 {
        return true;
    }
    if pos.y == 0 || pos.y == 32 {
...
#[inline]
#[must_use] pub fn get_edging_chunk(pos: IVec3) -> Option<IVec3> {
...
#[inline]
#[must_use] pub const fn make_vertex_u32(
...
#[inline]
#[must_use] pub fn world_to_chunk(pos: Vec3) -> IVec3 {
...
#[inline]
#[must_use] pub fn generate_indices(vertex_count: usize) -> Vec<u32> {
...
#[inline]
#[must_use] pub const fn vec3_to_index(pos: IVec3, bounds: i32) -> usize {
